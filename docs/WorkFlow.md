...
Xây dựng ứng dụng **Sàn Đấu Giá Trực Tuyến** , gồm các phân hệ & chức năng sauˮ
...
Tìm theo and/or tìm theo tên sản phẩm danh mục
...
Giá tăng dần
Những sản phẩm mới đăng (trong vòng N phút) sẽ có thể hiện khác với các
sản phẩm còn lại (nổi bật hơn)
```
...
Tên sản phẩm
Giá hiện tại
Thông tin đang đặt giá cao nhất bidder
Giá mua ngay (nếu có)
Ngày đăng sản phẩm
Thời gian còn lại
Số lượt ra giá hiện tại
Người dùng có thể click vào category để chuyển nhanh sang màn hình XEM DANH
SÁCH SẢN PHẨM
...
Thời điểm đăng
Thời điểm kết thúc
Nếu thời điểm kết thúc ít hơn 3 ngày thì thể hiện theo định dạng tương
đối (relative time  3 ngày nữa, 10 phút nữa, ...)
Mô tả chi tiết sản phẩm
Lịch sử các câu hỏi và câu trả lời của những người tham gia đấu giá & người
bán
...
Bidder được đánh giá 10 lần, có 8 và 2, vậy điểm của này là 8/10  80%,
được phép tham gia đấu giá sản phẩm bidder
Bidder chưa từng được đánh giá được phép ra giá sản phẩm trong trường
hợp người bán cho phép
...
27/10/2025 1043 ****Khoa 6,000,
27/10/2025 943 ****Kha 5,900,
27/10/2025 843 ****Tuấn 5,800,
27/10/2025 743 ****Khánh 5,700,
```
### 2.4 Hỏi người bán về sản phẩm

```
Thực hiện tại view Xem chi tiết sản phẩm
Người bán nhận được email thông báo về câu hỏi của người mua, trong email
có kèm link mở nhanh view để trả lời Xem chi tiết sản phẩm
```
### 2.5 Quản lý hồ sơ cá nhân

```
Đổi thông tin email, họ tên, mật khẩu (có yêu cầu nhập mật khẩu cũ)
Xem điểm đánh giá và chi tiết các lần được đánh giá & đoạn nhận xét mà người
đánh giá gửi
...
Nếu có, khi có lượt đấu giá mới trước khi kết thúc 5 phút , sản phẩm tự
động gia hạn thêm 10 phút.
```

```
Các tham số 5 phút, 10 phút có thể được điều chỉnh bởi quản trị viên và
sẽ áp dụng cho toàn bộ các sản phẩm
```
### 3.2 Bổ sung thông tin mô tả sản phẩm

```
Bổ sung thông tin mô tả cho sản phẩm đã đăng
Thông tin mới được chèn (append) vào mô tả cũ, không được phép thay thế
mô tả cũ
電源入り撮影出来ましたが細部の機能までは確認していません。
不得意ジャンルの買い取り品の為細かい確認出来る知識がありません、ご了承くだ
さい。
簡単な確認方法が有れば確認しますので方法等質問欄からお願いします、終了日の
質問には答えられない場合があります。
付属品、状態は画像でご確認ください。
当方詳しくありませんので高度な質問には答えられない場合がありますがご了承く
ださい。
発送は佐川急便元払いを予定しています、破損防止の為梱包サイズが大きくなる事
がありますがご了承下さい。
中古品の為NC/NRでお願いします。
✏ 31/10/
```
- が大きくなる事がありますがご了承下さい。
✏ 5/11/
- 不得意ジャンルの買い取り品の為細かい確認出来る知識がありません、ご了承く
ださい。
...
```
Nếu người mua bị từ chối đang là người mua đặt giá cao nhất, sản phẩm
chuyển cho người mua có giá cao thứ nhì.
```
...
```
```
Được phép huỷ giao dịch và tự động 1 người thắng đấu giá. Trong
trường hợp này, đoạn nhận xét có nội dung: Người thắng không thanh
toán
```
...
```
Các chức năng cơ bản quản lý
Xem danh sách xin nâng cấp tài khoản bidder
...
Khuyến khích cài đặt thêm chức năng đăng nhập qua Google, Facebook,
Twitter, Github, ...
```
...
Với mỗi giao dịch **quan trọng** , hệ thống gửi 1 email cho các bên liên quan nhằm
thông báo
...
Hệ thống hỗ trợ đấu giá **tự động** , giúp người mua có thể thắng được sản phẩm đấu
giá với giá **thấp nhất** có thể
Người mua ra giá tối đa mà mình có thể trả cho sản phẩm


```
Giá hiện tại của sản phẩm sẽ liên tục được cập nhật dựa trên giá-tối-đa và
giá-tối-đa-của-người-mua-khác
Nếu 2 bidder ra cùng mức giá, bidder ra giá trước được ghi nhận là người-ra-
giá-cao-nhất
```
...
#2 10,100,000 10,100,000 #
#3 10,500,000 10,500,000 #
#1 10,800,000 10,800,000 #
#3 11,100,000 11,100,000 #
...
#1 11,000,000 10,000,000 #
#2 10,800,000 10,800,000 #
#3 11,500,000 11,100,000 #
#4 11,500,000 11,500,000 #
#4 11,700,000 11,600,000 #
Bidder không cần thao tác liên tục để đưa giá mới vào sản phẩm
Giá vào sản phẩm luôn lá giá vừa-đủ-thắng giá của khác
bidder
```
...
Sau khi kết thúc phiên đấu giá, người bán và người mua khi truy cập vào chi tiết
sản phẩm sẽ được dẫn sang view **Hoàn tất đơn hàng** , các người dùng khác thì chỉ
thấy thông tin cơ bản của sản phẩm kèm thông báo **Sản phẩm đã kết thúc**
...
 Người mua và người bán đánh giá chất lượng giao dịch (+/- điểm kèm nhận xét
ngắn)
Trong quá trình **hoàn tất đơn hàng** , người bán có thể cancel giao dịch bất kỳ lúc
nào và đánh giá 1 cho người thắng cuộc. Ví dụ: người bán yêu cầu thanh toán
trong vòng 24h sau khi kết thúc đấu giá, nhưng người mua không đáp ứng được,
người bán huỷ giao dịch.
Giữa người bán và người thắng đấu giá luôn có một giao diện chat thân thiện để
trao đổi các thông tin cần thiết trong quá trình **hoàn tất đơn hàng**.
Người bán và người mua luôn được phép thay đổi kết quả đánh giá (+/-) của mình
cho phù hợp với mong muốn bản thân.
...
```
Web App SSR MVC ho ặc CSR ReactJS hoặc kết hợp
Technical Stack SSR
framework: expressjs
...
Có thể bổ sung các hiệu ứng để tăng tính tiện dụng của từng chức năng cụ
thể
...
```
Cần có ít nhất 20 sản phẩm thuộc 45 danh mục, nội dung mô tả & hình ảnh
đầy đủ.
